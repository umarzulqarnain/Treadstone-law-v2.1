    ...
    <!--begin::Login-->
        ...
        <div class="login-aside d-flex flex-column flex-row-auto">
            ...
            <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                <!--begin::Aside header-->
                <a href="<?php echo e(URL::to('/')); ?>" class="login-logo text-center pt-lg-25 pb-10">
                    <img src="<?php echo e(URL::to('images/tread-logo.png')); ?>" class="max-h-100px" alt="" />
            ...
            <!--end::Aside Top-->
            <!--begin::Aside Bottom-->
            <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center" style="background-position-y: calc(100% + 5rem); background-image: url( <?php echo e(URL::to('images/houseimg.png')); ?> )"></div>
            <!--end::Aside Bottom-->
        </div>
        <!--begin::Aside-->
        <!--begin::Content-->
                ...
                <!--begin::Title-->
                    <div class="pb-5 pb-lg-15">
                        ...
                        <div class="text-muted font-weight-bold font-size-h4">New Here ?
                            <a href="<?php echo e(route('register')); ?>" class="text-primary font-weight-bolder">Create Account</a></div>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between mt-n5">
                                ...
                                <a href="<?php echo e(route('password.forgot')); ?>" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">Forgot your password ?</a>
                            </div>
...
<!--end::Body-->
</html><?php /**PATH /home/u361969929/domains/bourne.shadowlabs.ca/resources/views/auth/login.blade.php ENDPATH**/ ?>