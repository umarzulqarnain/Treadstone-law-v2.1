...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input type="date" name="birth_date" max="2999-12-31" min="1800-12-31" value="<?php echo e($user->birth_date); ?>" id="birthdate" required="" class="form-control form-control-lg form-control-solid" im-insert="true">
                                            </div>
                                        </div>

                                        <?php if($user->type == "Realtor" || $user->type == "MortgageBroker" ): ?>
                                        <div class="form-group row">
                        ...
                        <div class="tab-pane" id="useFiles">
                            <div class="card card-custom">
                                <!--begin::Form-->
                                <form  method="post" action="<?php echo e(route('update.user.password')); ?>" enctype="multipart/form-data" accept-charset="utf-8">
                                    <?php echo csrf_field(); ?>
                                    <div class="card card-custom">
                                        <!--begin::Header-->
                                        <div class="card-header py-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                ...
                                                <a href="<?php echo e(route('password.forgot')); ?>" class="text-sm font-weight-bold">Forgot Password ?</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input type="password" name="new_password" value="" id="new_password" required class="form-control <?php echo e($errors->has('new_password') ? ' is-invalid' : ''); ?> form-control-lg form-control-solid">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input id="confirm_password" type="password"  value=""  name="confirm_password" required class="form-control <?php echo e($errors->has('confirm_password') ? ' is-invalid' : ''); ?> form-control-lg form-control-solid">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u361969929/domains/bourne.shadowlabs.ca/resources/views/profile.blade.php ENDPATH**/ ?>