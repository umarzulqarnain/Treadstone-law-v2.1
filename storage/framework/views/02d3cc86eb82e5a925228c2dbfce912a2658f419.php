                        ...
                        <div class="card-body px-5">
                            ...
                            <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                                ...
                                <div class="navi-item my-2">
                                    <a href="<?php echo e(route('messages')); ?>" class="navi-link ">
                                ...
                                <div class="navi-item my-2 ">
                                    <a href="<?php echo e(route('messages.sent')); ?>" class="navi-link active">
															<span class="navi-icon mr-4 ">
																<span class="svg-icon svg-icon-lg">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap w-xxl-200px mr-3" data-toggle="view">
                                                ...
                                                <div class="symbol symbol-light-<?php echo e($random_value); ?> symbol-35 mr-3">
                                                    <span class="symbol-label font-weight-bolder"> <?php echo e(mb_substr($message->receiver->name, 0, 1, "UTF-8")); ?> <?php echo e(mb_substr($message->sender->last_name, 0, 1, "UTF-8")); ?></span>
                                                </div>
                                                <a href="#" style="text-transform: capitalize" class="font-weight-bold text-dark-75 text-hover-primary"><?php echo e($message->receiver->name); ?> <?php echo e($message->receiver->last_name); ?></a>
                                            </div>
                                            <!--end::Author-->
                                        </div>
                                        <!--end::Toolbar-->
                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        <div class="card-header align-items-center flex-wrap justify-content-between py-5 h-auto">
                            ...
                            <div style="text-transform: capitalize" class="d-flex align-items-center my-2">
                                ...
                                <b><?php echo e($row->receiver['name']); ?> <?php echo e($row->receiver['last_name']); ?>  </b>
                                            ...
                                            <div class="d-block">
                                                ...
                                                <div  style="display: none !important;" class="d-flex  align-items-center border-bottom inbox-to px-8 min-h-45px">
                                                    ...
                                                    <div class="d-flex align-items-center flex-grow-1">
                                                      <input  hidden type="text" name="user_id" value="<?php echo e($row->user_id); ?>">
                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u361969929/domains/bourne.shadowlabs.ca/resources/views/sent_messages.blade.php ENDPATH**/ ?>