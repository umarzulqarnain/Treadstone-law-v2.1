    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="d-flex flex-row">
                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        <div class="card-body px-5">
                            ...
                            <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                                ...
                                <div class="navi-item my-2">
                                    <a href="<?php echo e(route('messages.sent')); ?>" class="navi-link">
															<span class="navi-icon mr-4">
																<span class="svg-icon svg-icon-lg">
                        ...
                        <div class="card-header row row-marginless align-items-right flex-wrap py-5 h-auto">
                            ...
                            <div class="col-12 col-sm-12 col-xxl-12 order-2 order-xxl-3 d-flex align-items-right justify-content-sm-end text-right my-2">
                                ...
                                <div class="d-flex align-items-center mr-2" data-toggle="tooltip" title="" data-original-title="Records per page">
                                    <span class="text-muted font-weight-bold mr-2" data-toggle="dropdown">1 - 10 of 2</span>
                        ...
                        <div class="card-body table-responsive px-0">
                            ...
                            <div class="list list-hover min-w-500px" data-inbox="list">
                                ...
                                <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div style="cursor: pointer" class="d-flex align-items-start list-item card-spacer-x py-3 contact_message_click contact_message-<?php echo e($message['id']); ?>" data-id="<?php echo e($message['id']); ?>"  data-number="0" >
                                        <!--begin::Toolbar-->
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap w-xxl-200px mr-3" data-toggle="view">
                                                ...
                                                <div class="symbol symbol-light-<?php echo e($random_value); ?> symbol-35 mr-3">
                                                    <span class="symbol-label font-weight-bolder"> <?php echo e(mb_substr($message->sender->name, 0, 1, "UTF-8")); ?> <?php echo e(mb_substr($message->sender->last_name, 0, 1, "UTF-8")); ?></span>
                                                </div>
                                                <a href="#" style="text-transform: capitalize" class="font-weight-bold text-dark-75 text-hover-primary"><?php echo e($message->sender->name); ?> <?php echo e($message->sender->last_name); ?></a>
                                            </div>
                                            <!--end::Author-->
                                        </div>
                                        <!--end::Toolbar-->
                                        ...
                                        <div class="flex-grow-1 mt-2 mr-2" data-toggle="view">
                                            <div>
                                                <span class="font-weight-bolder font-size-lg mr-2"><?php echo e($message['subject']); ?></span>
                                                ...
                                                <span class="text-muted"><?php echo e($message_body); ?>..</span>
                                            </div>

                                        </div>
                                        <!--end::Info-->
                                        <!--begin::Datetime-->
                                        <div class="mt-2 mr-3 font-weight-normal w-100px text-right text-muted" data-toggle="view"> <?php echo e(Carbon\Carbon::parse($message['created_at'])->diffForHumans()); ?> </div>
                                        <!--end::Datetime-->
                                    </div>
                ...
                <div id="kt_inbox_view" class="flex-row-fluid ml-lg-8 d-none kt_inbox_view-<?php echo e($row->id); ?>">
                    <!--begin::Card-->
                    <div class="card card-custom card-stretch">
                        <!--begin::Header-->
                        <div class="card-header align-items-center flex-wrap justify-content-between py-5 h-auto">
                            ...
                            <div style="text-transform: capitalize" class="d-flex align-items-center my-2">
                                <a  href="#" class="btn btn-clean btn-icon btn-sm mr-6 back_to_list"  data-id="<?php echo e($row->id); ?>">
                                    <i class="flaticon2-left-arrow-1"></i>
                                </a>

                                <b><?php echo e($row->sender['name']); ?> <?php echo e($row->sender['last_name']); ?>  </b>
                    ...
                    $convo_msgs = \App\Messages::where([['sender_id' , '=' , $row->sender['id'] ] , ['user_id' , '=' , auth()->user()->id] ] )
                                    ->orWhere([['user_id' , '=' , $row->sender['id'] ] , ['sender_id' , '=' , auth()->user()->id] ] )
                                    ->orderby('created_at')
                                    ->get();
                    ...
                    ?>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="mb-3">
                                ...
                                <?php $__currentLoopData = $convo_msgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <div id="message_self<?php echo e($msg->id); ?>" class="cursor-pointer shadow-xs message_self toggle-off" data-id="<?php echo e($msg->id); ?>"  >
                                    ...
                                    <div class="d-flex card-spacer-x py-6 flex-column flex-md-row flex-lg-column flex-xxl-row justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <span class="symbol symbol-50 mr-4">
                                                ...
                                                <div class="symbol symbol-light-<?php echo e($random_value); ?> symbol-35 mr-3">
                                                    <span class="symbol-label font-weight-bolder"> <?php echo e(mb_substr($msg->sender['name'], 0, 1, "UTF-8")); ?> <?php echo e(mb_substr($msg->sender['last_name'], 0, 1, "UTF-8")); ?></span>
                                                </div>

                                            </span>
                                            <div class="d-flex flex-column flex-grow-1 flex-wrap mr-2">
                                                <div class="d-flex">
                                                    <a href="#" class="font-size-lg font-weight-bolder text-dark-75 text-hover-primary mr-2"><?php echo e($msg->sender['name']); ?></a>
                                                    <div class="font-weight-bold text-muted">
                                                        <span class="label label-success label-dot mr-2"></span><?php echo e(Carbon\Carbon::parse($msg->created_at)->diffForHumans()); ?></div>
                                                </div>
                                        ...
                                        <div class="d-flex my-2 my-xxl-0 align-items-md-center align-items-lg-start align-items-xxl-center flex-column flex-md-row flex-lg-column flex-xxl-row">
                                            <div class="font-weight-bold text-muted mx-2"><?php echo e($msg->created_at); ?></div>
                                        </div>
                                    </div>
                                    <!--end::Message Heading-->
                            ...
                            <div class="card-spacer mb-3" id="kt_inbox_reply">
                                <div class="card card-custom shadow-sm">
                                    <div class="card-body p-0">
                                        <!--begin::Form-->
                                        <form id="kt_inbox_compose_form"  method="post" action="<?php echo e(route('message.send')); ?>">
                                            <?php echo csrf_field(); ?>
                                            <!--begin::Header-->
                                            ...
                                            <div class="d-block">
                                                ...
                                                <div  style="display: none !important;" class="d-flex  align-items-center border-bottom inbox-to px-8 min-h-45px">
                                                    ...
                                                    <div class="d-flex align-items-center flex-grow-1">
                                                      <input  hidden type="text" name="user_id" value="<?php echo e($row->sender_id); ?>">
                                                    </div>
                                                ...
                                                <div id="contentmsg-<?php echo e($row->id); ?>" style="height: 250px;">

                                                </div>
                                                <textarea id="contentmsg-<?php echo e($row->id); ?>-textarea" type="textarea" class="form-control "  row="5" name="body" style="display: none;">
                                                </textarea>
                                                <!--end::Message-->
                                                <!--begin::Attachments-->
                                                <!--end::Attachments-->
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/pages/custom/inbox/inbox.js')); ?>"></script>
...
//                    localStorage.setItem('selectedTab-'+viewId, viewId)
    ...
    <script src="<?php echo e(asset('js/pages/crud/forms/widgets/select2.js')); ?>"></script>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u361969929/domains/bourne.shadowlabs.ca/resources/views/messages.blade.php ENDPATH**/ ?>