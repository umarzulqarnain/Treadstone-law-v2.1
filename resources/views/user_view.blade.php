                                ...
                                <form  method="post" action="{{ route('update.user.info') }}" enctype="multipart/form-data" accept-charset="utf-8">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                ...
                                                <span class="input-group-text">
                                                    ...
                                                    <input type="email" name="email" value="{{ $user->fake_email }}" id="email" required class="form-control form-control-lg @error('email') is-invalid @enderror form-control-solid" >
                                                    @error('email')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input type="date" name="birth_date" value="{{ $user->birth_date }}" id="birthdate" required="" class="form-control form-control-lg form-control-solid" im-insert="true">
                                            </div>
                                        </div>
                                        @if((auth()->user()->type == "Admin" ||
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="card card-custom gutter-b card-stretch">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0 mr-4 symbol symbol-65 symbol-circle">
                                                        <span style="background-color: {{ $random_value }} !important;width: 54px !important;border-radius: 50%; height: 54px !important;" class="bullet bullet-bar bg-{{$random_value}} align-self-stretch"></span>
                                                    ...
                                                    <div class="d-flex flex-column mr-auto">
                                                        <!--begin: Title-->
                                                        <a  class="card-title text-hover-primary font-weight-bolder font-size-h5 text-dark mb-1"> Property {{ $row->file_type }}</a>
                                                        <span class="text-muted font-weight-bold"> {{ $row->address }}</span>
                                                        <!--end::Title-->
                                                    </div>
                                                    <!--end::Info-->
                                                    <!--begin::Toolbar-->
                                                ...
                                                <div class="d-flex flex-wrap mt-14">
                                                    <div class="mr-12 d-flex flex-column mb-7">
                                                        ...
                                                        <span class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text"> {{ $row->created_at }}</span>
                                                    </div>
                                                    <div class="mr-12 d-flex flex-column mb-7">
                                                    ...
                                                    <div class="flex-row-fluid mb-7">
                                                        ...
                                                        <div class="d-flex align-items-center pt-2">
                                                            ...
                                                            <span class="ml-3 font-weight-bolder">{{ substr($totalpercentage , 0 , 4) }}%</span>
                                                        </div>
                                                    </div>
                                                    <!--end::Progress-->
                                                </div>
                                                    ...
                                                    <div class="d-flex flex-column flex-lg-fill float-left mb-7">
                                                        ...
                                                        <div class="symbol-group symbol-hover">
                                                            <div class="symbol symbol-30 symbol-circle symbol-light">
                                                                <span class="symbol-label font-weight-bold">{{ $row->sellers() }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--end::Item-->
                                            ...
                                            <div class="card-footer d-flex align-items-center">
                                                ...
                                                <a type="button" href="{{route('file.show' , $row->id)  }}" class="btn btn-primary btn-sm text-uppercase font-weight-bolder mt-5 mt-sm-0 mr-auto mr-sm-0 ml-sm-auto">details</a>
                                            </div>
                                            <!--end::Footer-->
                                        </div>
                                        <!--end::Card-->
