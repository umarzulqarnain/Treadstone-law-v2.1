...
@section('content')
    ...
    <div class="subheader py-3 py-lg-8 subheader-transparent" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap">
                ...
                <a href="{{ route('messages') }}" class="btn btn-primary btn-icon font-weight-bold mr-2"  >
                    <span class="svg-icon svg-icon-lg">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0 mr-4 symbol symbol-65 symbol-circle">
                                    ...
                                    ?>
                                    <span style="background-color: {{ $random_color }} !important;width: 54px !important;border-radius: 50%; height: 54px !important;display: flex;align-items: center;justify-content: center;" class="bullet bullet-bar bg-{{$random_color}} align-self-stretch">
                                            <i class="icon-2x text-white flaticon-home"></i>
                                    </span>

                                    {{--<img src="{{ asset('media/3.png') }}" alt="image" />--}}
                                </div>
                                <!--end::Pic-->
                                <!--begin::Info-->
                                <div class="d-flex flex-column mr-auto">
                                    <!--begin: Title-->
                                    <a  href="{{route('file.show' , $row->id)  }}" class="side-link card-title text-hover-primary font-weight-bolder font-size-h5 text-dark mb-1">{{ isset($row->file_name)  ? $row->file_name : 'Property ' . $row->file_type }} </a>
                                    <span class="text-muted font-weight-bold">  {{  !empty($row->prop['address']) ? $row->prop['address'].', '  : ''  }}{{  !empty($row->prop['city']) ? $row->prop['city'].', '  : ''  }}{{  !empty($row->prop['province']) ? $row->prop['province'].', ' : '' }}{{  !empty($row->prop['postal_code']) ? $row->prop['postal_code'] : '' }} </span>
                                    <!--end::Title-->
                                </div>
                                ...
                                @if(auth()->user()->type=="Admin")
                                    ...
                                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
                                        ...
                                        <ul class="navi navi-hover py-0">
                                            ...
                                            <li class="navi-item">
                                                <a href="#" data-toggle="modal" data-target="#edit_file_modal-{{ $row->id }}" data-action="{{ route('file.update.name' , $row->id) }}" class="navi-link">
                                                    <span class="navi-icon">
                                            ...
                                            <li class="navi-item">
                                                <a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="{{ route('file.delete' , $row->id) }}" data-id="{{ $row->id }}"
                            ...
                            <div class="d-flex flex-wrap mt-14">
                                ...
                                <div class="mr-12 d-flex flex-column mb-7">
                                    ...
                                    <span class="btn btn-light-success btn-sm font-weight-bold btn-upper btn-text"> {{ $row->file_type}}</span>
                                </div>
                                @else
                                    <div class="mr-12 d-flex flex-column mb-7">
                                        <span class="d-block font-weight-bold mb-4">File Opened</span>
                                        <span class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text"> {{ $row->created_at->format('Y-m-d') }}</span>
                                    </div>
                                @endif
                                <div class="mr-12 d-flex flex-column mb-7">
                                    <span class="d-block font-weight-bold mb-4">Closing Date</span>
                                    <span class="btn btn-light-danger btn-sm font-weight-bold btn-upper btn-text"> {{ $row->closing_date }}</span>
                                </div>
                                <!--begin::Progress-->
                                <div class="flex-row-fluid mb-7">
                                    <span class="d-block font-weight-bold mb-4">Progress</span>
                                    <div class="d-flex align-items-center pt-2">
                                        @if($row->file_type=="Sale")
                                            <?php
                                        ...
                                        <div class="progress progress-xs mt-2 mb-2 w-100">
                                            <div class="progress-bar bg-warning" role="progressbar" style="width: {{ substr($totalpercentage , 0 ,4) }}%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <span class="ml-3 font-weight-bolder">{{  round(substr($totalpercentage , 0 , 4)/5) * 5   }}% </span>
                                    </div>
                                </div>
                                <!--end::Progress-->
                            </div>
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="mr-12 d-flex flex-column mb-7">
                                    ...
                                    <span class="font-weight-bolder font-size-h5 pt-1">
                                        ...
                                        @if($row->file_info['file_price']) {{ $row->file_info['file_price'] }} @else 0 @endif
                                    </span>
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex flex-column flex-lg-fill float-left mb-7">
                                    ...
                                    <div class="symbol-group symbol-hover">
                                           ...
                                           ?>
                                          @foreach($homeowners as $key=> $homie)
                                            <div class="symbol symbol-30 symbol-circle" data-toggle="tooltip" title="" data-original-title="{{ $homie['first_name'] }} {{ $homie['last_name'] }}">
                                                <img alt="Pic" @if($homie['gender'] =="male") src="{{ asset('media/001-boy.svg') }}" @else src="{{ asset('media/002-girl.svg') }}" @endif>
                                            </div>
                                           @endforeach
                                           @if($homeownersCount > 4)
                                            <div class="symbol symbol-30 symbol-circle symbol-light">
                                                <span class="symbol-label font-weight-bold">+{{ $homeownersCount-4 }}</span>
                                            </div>
                                           @endif
                                        </div>
                                </div>
                        ...
                        <div class="card-footer d-flex align-items-center">
                            <div class="d-flex">
                                <div class="d-flex align-items-center mr-7">
                                    ...
                                    <a class="font-weight-bolder text-primary ml-2">{{ $row->tasks() }} Tasks</a>
                                </div>
                            </div>
                            <a type="button" href="{{route('file.show' , $row->id)  }}" class="side-link btn btn-primary btn-sm text-uppercase font-weight-bolder mt-5 mt-sm-0 mr-auto mr-sm-0 ml-sm-auto">details</a>
                        </div>
                        <!--end::Footer-->
                    </div>
                    <!--end::Card-->
              ...
              @if( auth()->user()->type == "Realtor" ||
                  ...
                  <div class="row">
                     <div class="col-xl-12">
                      ...
                      <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b bg-primary" style="height: 200px; background-image: url({{ asset('media/taieri.svg') }})">
                              ...
                              <div class="d-flex py-5 flex-column align-items-start flex-grow-1 row">
                                  ...
                                  <div class="col-12 col-md-6">
                                      ...
                                      <div class=" align-items-center flex-wrap">
                                          ...
                                          <br>
                                          <form class="form" method="POST" action="{{ route('send.intro.mail') }}" enctype="multipart/form-data">
                                              @csrf
                          ...
                          <table class="table table-head-custom table-vertical-center kt_datatable" id="">
                              ...
                              @foreach($files as $key => $row)
                                  <tr>
                                          ...
                                          <div class="d-flex align-items-center">
                                              ...
                                              <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">
                                                  <p style=" overflow: hidden;white-space: nowrap;text-overflow: ellipsis;max-width: 200px;">
                                                      @foreach($row->sellers as $hkey=> $homeowner)
                                                          @if($hkey>0)
                                                             @if(!isset($homeowner->last_name) || $homeowner->last_name =="")  @else   {{ '/'.$homeowner->last_name }} @endif
                                                          @else
                                                              @if(!isset($homeowner->last_name) || $homeowner->last_name =="")  @else   {{ $homeowner->last_name }} @endif
                                                          @endif
                                                      @endforeach
                                              ...
                                              <a class="text-muted font-weight-bold text-hover-primary"><p style=" overflow: hidden;white-space: nowrap;text-overflow: ellipsis;max-width: 200px;">{{  !empty($row->prop->address) ? $row->prop->address.', '  : ''  }}{{  !empty($row->prop->city) ? $row->prop->city.', '  : ''  }}{{  !empty($row->prop->province) ? $row->prop->province .', ' : '' }}{{  !empty($row->prop->postal_code) ? $row->prop->postal_code : '' }} </p></a>
                                          </div>
                                          </div>
                                      </td>
                                      <td class="pr-0" width="200">
                                          <div class="symbol symbol-50 symbol-light mt-1">
                                              <div class="d-inline font-weight-bolder text-primary mb-0">{{  \Carbon\Carbon::parse($row['closing_date'])->format('M j, Y') }}</div>
                                          </div>
                                      </td>
                                      <td class="pr-0" width="100">
                                          <div class="symbol symbol-50 symbol-light mt-1">
                                              <span class="d-inline label label-lg font-weight-bold  label-light-success label-inline" style="color:blueviolet" >{{ $row['file_type'] }}</span>
                                          </div>
                                      </td>
                                      <td class="pr-0" width="50">
                                          <div class="symbol symbol-50 symbol-light mt-1">
                                              <span class="d-inline label label-lg font-weight-bold  label-light-success label-inline">{{ Carbon\Carbon::now()->diffInDays($row->closing_date, false) }}</span>
                                          </div>
                                      </td>
                                      <td class="pr-0" width="50">
                                          <div class="symbol symbol-50 symbol-light mt-1">
                                              ...
                                              @if( $daysToClose > 30 )
                                                  <span class="d-inline label label-lg font-weight-bold  label-light-success label-inline">{{  round(substr($totalpercentage , 0 , 4)/5) * 5   }}%</span>
                                             @elseif( $daysToClose < 30 && $perc <= 35 )
                                                      <span class="d-inline label label-lg font-weight-bold  label-light-danger label-inline">{{  round(substr($totalpercentage , 0 , 4)/5) * 5   }}%</span>
                                              @elseif( $daysToClose < 30 && $perc >= 36 && $perc <= 99  )
                                                  <span class="d-inline label label-lg font-weight-bold  label-light-warning label-inline">{{  round(substr($totalpercentage , 0 , 4)/5) * 5   }}%</span>
                                              @elseif($daysToClose < 30 && $perc == 100  )
                                                  <span class="d-inline label label-lg font-weight-bold  label-light-primary label-inline">{{  round(substr($totalpercentage , 0 , 4)/5) * 5   }}%</span>
                                              @endif
                                      ...
                                      <td class="pr-0" width="100">
                                          <div class="symbol symbol-50 symbol-light mt-1">
                                              <span class="d-inline label label-lg font-weight-bold  label-light-success label-inline" style="color:blueviolet" >{{ $row->tasks() }}</span>

                                          </div>
                                      </td>
                                      <td class="pr-0" width="100">
                                          <div class="symbol symbol-50 symbol-light mt-1">
                                              <a href="#" data-toggle="modal" data-target="#edit_file_modal-{{ $row->id }}" data-action="{{ route('file.update.name' , $row->id) }}" class=" btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" >
                                              ...
                                              <a href="{{route('file.show' , $row->id )  }}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">
                                                  <span class="svg-icon svg-icon-md">
                                              ...
                                              <a @if( (auth()->user()->type == "Realtor" ||
                                                    auth()->user()->type == "MortgageBroker" ||
                                                   auth()->user()->type == "OtherSide") && $row->updated_at ==""   )

                                                 @else
                                                 href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="{{ route('file.delete' , $row->id) }}" data-id="{{ $row->id }}"
                                                 @endif   class="open_delete_modal btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon" title="Delete">
                                                  <span class="svg-icon svg-icon-md">
    ...
    @if(auth()->user()->type != "Admin" && !auth()->user()->agreed_to_terms)
                        ...
                        <div class="modal-body">
                            <div data-scroll="true" data-height="300" class="scroll ps ps--active-y" style="height: 300px; overflow: hidden;">
                                ...
                                {{--<div class="ps__rail-y" style="top: 210px; right: 0px; height: 300px;">--}}
                                    {{--<div class="ps__thumb-y" tabindex="0" style="top: 62px; height: 88px;"></div>--}}
                                {{--</div>--}}
                            </div>
                        </div>
    ...
    @foreach($files as $key => $file)
        <div class="modal fade" id="edit_file_modal-{{ $file->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeSm" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="form" method="POST" action="{{ route('file.update.name' , $file->id) }}" enctype="multipart/form-data">
                    @csrf
                <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <input style="text-transform: capitalize" class="form-control form-control-lg form-control-solid" name="file_name" type="text" value="{{ $file['file_name'] }}"  />
                            </div>
                        </div>
