...
<head>
    <meta charset="utf-8" />
    <title> TreadStone Law | Register </title>
        ...
        <div class="login-content flex-column-fluid d-flex flex-column p-10">
            ...
            <div class="d-flex flex-row-fluid flex-center">
                ...
                <div class="login-form login-form-signup">
                    ...
                    <form id="kt_login_signup_form" method="POST" action="{{ route('register') }}">
                        @csrf
                        <!--begin: Wizard Step 1-->
                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                            ...
                            <div class="form-group firstcont">
                                ...
                                <input  style="padding: 12px" type="text" id="name"  name="name" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 @error('name') is-invalid @enderror user_first_name"  required autocomplete="name" autofocus>
                                <input hidden style="padding: 12px" type="text"  name="type" class="form-control user_type " value="Client" >
                                <input hidden  style="padding: 12px" type="text"  name="token" class="form-control "  autocomplete="none" value="{{ request()->segment(2) }}" >
                            ...
                            <div class="form-group">
                                ...
                                <input  style="padding: 12px" type="text" id="last_name"  name="last_name" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 @error('name') is-invalid @enderror user_last_name" value="{{ old('name') }} " required autocomplete="name" autofocus>
