...
<div style="overflow-y: scroll; height: 100%;">
    ...
    <input hidden class="authUserType" value="{{ auth()->user()->type }}" >
    <!--begin::Main-->
    <!--begin::Header Mobile-->
    <div id="kt_header_mobile" class="header-mobile">
        <!--begin::Logo-->
        <a href="{{ URL::to('/') }}">
            <img alt="Logo" src="{{ URL::to('images/tread-logo.png') }}" class="logo-default max-h-30px" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
                    ...
                    <div class="modal-body">
                        <div class="wizard wizard-1" id="kt_file_add_sale" data-wizard-state="step-first" data-wizard-clickable="true">
                                ...
                                <div class="wizard-steps p-8 p-lg-10">
                                    ...
                                    <div class="wizard-step " data-wizard-type="step">
                                        <div class="wizard-label">
                                            ...
                                            <h3 class="wizard-title"> @if(auth()->user()->type != "Client") Client @else Your @endif Information</h3>
                                        </div>
                                        <span class="svg-icon svg-icon-xl wizard-arrow">
                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                <div class="col-xl-12 @if(auth()->user()->type == "Admin") col-xxl-7 @else col-xxl-9 @endif ">
                                    <!--begin::Form Wizard-->
                                    <form class="form" id="kt_file_sale_add_form" method="POST" action="{{ route('file.create') }}" enctype="multipart/form-data">
                                        @csrf
                                        <!--begin::Step 1-->
                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    ...
                                                    <div @if(auth()->user()->type =="Realtor" ) style="display:flex" @else  style="display:none" @endif  class="form-group row">
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="form-group row">
                                                        <div class="col-lg-9 col-xl-6">
                                                            <h3 class="mb-10 font-weight-bold text-dark"> @if(auth()->user()->type != "Client") Client @else Your @endif  Information</h3>
                                                        </div>
                                                    </div>
                    ...
                    <div class="modal-body">
                        <div class="wizard wizard-1" id="kt_file_add_purchase" data-wizard-state="step-first" data-wizard-clickable="true">
                            ...
                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                <div class="col-xl-12 @if(auth()->user()->type == "Admin") col-xxl-7 @else col-xxl-9 @endif">
                                    <!--begin::Form Wizard-->
                                    <form class="form" id="kt_file_purchase_add_form" method="POST" action="{{ route('file.create') }}" enctype="multipart/form-data">
                                        @csrf
                                        <!--begin::Step 1-->
                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                            <h3 class="mb-10 font-weight-bold text-dark">File Details</h3>
                                        ...
                                        @if(auth()->user()->type =="Realtor" || auth()->user()->type =="MortgageBroker" )
                                            ...
                                            @elseif(auth()->user()->type == "MortgageBroker")
                                                <div class="form-group row">
                        ...
                        <div class="wizard wizard-1" id="kt_file_add_refinance" data-wizard-state="step-first" data-wizard-clickable="true">
                            ...
                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                <div class="col-xl-12 col-xxl-7 ">
                                    <!--begin::Form Wizard-->
                                    <form class="form" id="kt_file_refinance_add_form" method="POST" action="{{ route('file.create') }}" enctype="multipart/form-data">
                                        @csrf
                                        <!--begin::Step 1-->
                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                            <h3 class="mb-10 font-weight-bold text-dark">File Details</h3>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input id="email" type="email"  class="form-control form-control-lg form-control-solid @error('email') is-invalid @enderror" name="email" type="email" value="" required />
                                                            @error('email')
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input hidden type="text" name="ref_file" value="{{ request()->segment(2) }}" class="form-control">
                                <input hidden type="text" name="type" value="CLOSING_PACKAGE" class="form-control">
                            </div>
                            <form id="frmTarget"  class="form  dropzone needsclick dz-clickable" method="POST" action="{{ route('filedoc.create') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div id="dropzone" >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card-body">
                            ...
                            <form id="frmTargetTwo"  class="form  dropzone needsclick dz-clickable" method="POST" action="{{ route('filedoc.create') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div id="dropzone" >
                                        <div class="dz-message needsclick">
        ...
        <div class="modal fade" id="add_outstanding_task_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeSm" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!--begin::Form-->
                        <form class="form" method="POST" action="{{ route('task.create') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
        ...
        <div class="modal fade" id="add_document_request_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeSm" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <form id="addFileRequestForm" class="form" method="POST" action="{{ route('filedoc.create') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">

                            <div class="row form-group">

                                <input hidden type="text" class="form-control form-control form-control-solid " name="ref_file" value="{{ request()->segment(2) }}">
                            ...
                            <div class="col-xl-12 col-xxl-10">
                                            ...
                                            <form class="form" id="kt_homeowners_purchase_add_form_one" method="POST" action="" enctype="multipart/form-data">
                                                ...
                                                <div class="row d-none howmanyHomeowners  form-group">
                                                    <div class="col-12 col-md-6">
                                                        ...
                                                        {{--<input class="form-control form-control-lg form-control-solid homeOwnersNumber"  type="number" value="1"  />--}}
                                                    </div>
                                                    <div  class="col-12 col-md-6">
                                                            <br>
                                                ...
                                                <div id="SellerCount">
                                                    ...
                                                    <div id="homeOwnerInfoPart" >
                                                        ...
                                                        <div id="homeOwnerInfoPart" class="row form-group owner-sale-info-part ">
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <br>
                                                                <label class=" form-control-label">Is this @if(auth()->user()->type == "Client")your @else the client's @endif primary residence?</label>
                                                                <br>
                                                            </div>
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <br>
                                                                <label class=" form-control-label">@if(auth()->user()->type == "Client")Are you  @else Is the client  @endif legally married ?</label>
                                                                <br>
                                                            </div>
                                                            <div class="col-12 col-md-3">
                                                                <label class="officer-label">
                                                            ...
                                                            <div  class="col-12 col-md-6 isyourspouseon">
                                                                <br>
                                                                <label class=" form-control-label">@if(auth()->user()->type == "Client")Is your @else Is the client's  @endif spouse on title for this property?</label>
                                                                <br>
                                                            </div>
                                ...
                                <div class="pb-5" data-wizard-type="step-content">
                                    <div class="row">
                                        <div class="col-xl-12">
                                            ...
                                            {{--Please upload the front and back of two pieces of identification for the homeowner.--}}
                                            {{--</h5>--}}
                                            {{--<a class="btnfile dropzone-select btn btn-light-primary font-weight-bold btn-sm dz-clickable" data-content="six"  data-col="3" data-name="idgovs[]" data-multi="yes">Attach Files</a>--}}
                                            {{--</div>--}}
                                            {{--</div>--}}
                                        ...
                                        <div id="SellerAddressCount">
                                            <div id="homeOwnerAddressPart" class="owner-sale-address-part ">
                                                ...
                                                <div class="form-group row">
                                                    {{--<div style="display:none"  class="col col-md-2">--}}
                                                        {{--<br>--}}
                                                        {{--<a href="#" class="btn btn-light-success font-weight-bold mr-2 remove-homeownerAddress"><i class="ki ki-bold-close icon-sm"></i></a>--}}
                                                    {{--</div>--}}
                                                    <div class="col-12 col-md-6">
                                                        <br>
                                ...
                                <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                    ...
                                    <div style="width:50%">
                                        ...
                                        <input style="margin-top:-10px"  class="form-control form-control-lg form-control-solid  fullnametxt"  type="text"  placeholder="Enter Your Full Name Here" value="@if(auth()->user()->type != "Client") Admin Admin @endif" />
                                    </div>
                        ...
                        <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-10">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <form class="form" id="kt_homeowners_purchase_add_form_one" method="POST" action="" enctype="multipart/form-data">
                                                ...
                                                <div class="row @if(auth()->user()->type  != "Client") d-none @endif howmanyHomeownersPurchase form-group">
                                                        <div class="col-12 col-md-6">
                                                            <br>
                                                ...
                                                <div id="SellerCountPurchase">
                                                    ...
                                                    <div id="homeOwnerInfoPartContainer" >
                                                        ...
                                                        <div id="homeOwnerInfoPart" class="row form-group owner-purchase-info-part  ">
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <br>
                                                                <label class=" form-control-label">@if(auth()->user()->type == "Client")Are you @else Is the client  @endif purchasing @if(auth()->user()->type == "Client") your  @else their  @endif primary residence?</label>
                                                                <br>
                                                            </div>
                                                            ...
                                                            <div  class="col-12 col-md-6 isyourspouseon">
                                                                <br>
                                                                <label class=" form-control-label">Will @if(auth()->user()->type == "Client") your @else the client's @endif spouse be on title for the property being
                                                                    purchased?</label>
                                                                <br>
                                                            </div>
                                                            <div  class="col-12 col-md-3 isyourspouseon">
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content">
                                            ...
                                            <div id="homeownerReviewCounterPruchase">
                                                ...
                                                <div id="homeowner-review-part" class="owner-purchase-review-part " >
                                                    ...
                                                    {{--<h6 class="font-weight-bolder mb-3">ID ONE</h6>--}}
                                                    {{--<div class="text-dark-50 line-height-lg">--}}
                                                    {{--<div>Front :<span class="id1_front"> </span> </div>--}}
                                                    {{--<div>Back : <span class="id1_back"> </span> </div>--}}
                                                    {{--</div>--}}
                                                    {{--<br>--}}
                                                    {{--<h6 class="font-weight-bolder mb-3">ID TWO</h6>--}}
                                                    {{--<div class="text-dark-50 line-height-lg">--}}
                                                    {{--<div>Front :<span class="id2_front"> </span> </div>--}}
                                                    {{--<div>Back : <span class="id2_back"> </span> </div>--}}
                                                    {{--</div>--}}
                                                    {{--<br>--}}
                                ...
                                <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                    ...
                                    <div style="width:50%">
                                        <p style="color:#c4c2c2;margin-top:-18px" class="fullnametxt-title">I confirm that the information entered is correct.</p>
                                        <input style="text-transform: capitalize; margin-top:-10px"  class="form-control form-control-lg form-control-solid  fullnametxt"  type="text"  placeholder="Enter Your Full Name Here" value="@if(auth()->user()->type != "Client") Admin Admin @endif" />
                                    </div>
                                    <div>
                    ...
                    <div class="wizard wizard-1" id="kt_sellers_buyers_master_add" data-wizard-state="step-first" data-wizard-clickable="true">
                            ...
                            <div class="wizard-steps p-8 p-lg-10">
                                <div class="wizard-step" onclick="hideSignatureBox('kt_sellers_buyers_master_add')" data-wizard-type="step" data-wizard-state="current">
                                    ...
                                    <span class="svg-icon svg-icon-4x wizard-icon">
                                        ...
                                        <h3 class="wizard-title">{{ $type }} Information</h3>
                                    </div>
                                    <span class="svg-icon svg-icon-xl wizard-arrow">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-8">
                                ...
                                <!--begin::Step 1-->
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    <h3 class="mb-10 font-weight-bold text-dark">{{ $type }} Information</h3>
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <form class="form" id="kt_sellers_add_form_one" method="POST" action="" enctype="multipart/form-data">
                                                @csrf

                                                <div class="row @if( auth()->user()->type == "Client"  || ( auth()->user()->type == "OtherSide" && auth()->user()->first_login ) )  @else d-none @endif howmanySellersBuyers form-group">
                                                    <div class="col-12 col-md-12">
                                                        <br>
                                                        <label class="form-control-label">What's the total number of {{$type}}s?</label>
                                                    </div>
                                                    <div class="col-12 col-md-12">
                                                        <br>
                                                        <label class="officer-label float-left" style="margin-right: 20px">
                                                ...
                                                <div id="BuyersCount">
                                                    ...
                                                    <div id="buyer-info-part" class="row form-group buyer-info-part">
                                                        ...
                                                        <div class="col-12 col-md-12">
                                                            <br>
                                                            <label class="form-control-label font-weight-bold">{{ $type }} 1 </label>
                                                        </div>
                                        ...
                                        <div class="col-xl-12">
                                            <form class="form" id="kt_lawyer_master_add_form" method="POST" action="" enctype="multipart/form-data">
                                                ...
                                                <div id="lawyer-info-part" class="row form-group" >
                                                    <div class="col-12 col-md-12">
                                                        <br>
                                                        <label class=" form-control-label">Please provide details for {{ $type }}'s lawyer</label>
                                                    ...
                                                    <div class="col-12 col-md-12">
                                                        ...
                                                        <input hidden type="text" class="form-control form-control-lg form-control-solid firm_seller_name" name="ref_file" value="{{ request()->segment(2) }}" >
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        ...
                                                        <label class=" form-control-label">First Name</label>
                                                        <input style="text-transform: capitalize"  type="text" class="form-control form-control-lg form-control-solid lawyer_master_first_name" name="lawyer_first_name" value="{{ isset($lawyer) ? $lawyer['first_name'] : '' }}">
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <br>
                                                        <label  class=" form-control-label">Last Name</label>
                                                        <input style="text-transform: capitalize"  type="text" class="form-control form-control-lg form-control-solid lawyer_master_last_name" name="lawyer_last_name" value="{{ isset($lawyer) ? $lawyer['last_name'] : '' }}">
                                                    </div>
                                    ...
                                    <div class="pb-5" data-wizard-type="step-content">
                                        ...
                                        <div id="BuyerSellerMasterReviewCounter">
                                            ...
                                            <div id="buyerseller_master-review-part" class="buyerseller_master-review-part-1" >
                                                ...
                                                <h2 class="mb-10 font-weight-bold text-dark">{{ $type }} 1</h2>
                                                <h6 class="font-weight-bolder mb-3">Personal Information</h6>
                                                <div class="text-dark-50 line-height-lg">
                                                    <div><span class="first_name"> </span> <br> <span class="last_name"> </span>   </div>
                                                    <div><span class="gender"> </span></div>
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    <div class="row">
                                        <div class="col-xl-12">
                                            ...
                                            <form class="form" id="kt_lawyer_add_form" method="POST" action="{{ route('lawyer.store') }}" enctype="multipart/form-data">
                                                @csrf
                                                <div id="lawyer-info-part" class="row form-group" >
                                                    <div class="col-12 col-md-12">
                                                        <br>
                                                    ...
                                                    <div class="col-12 col-md-12">
                                                        <br>
                                                        <label class=" form-control-label">Firm Name</label>
                                                        <input type="text" class="form-control form-control-lg form-control-solid lawyer_firm_name" name="firm_name" value="{{ isset($lawyer) ? $lawyer['firm_name'] : '' }}" >
                                                        <input hidden type="text" class="form-control form-control-lg form-control-solid firm_seller_name" name="ref_file" value="{{ request()->segment(2) }}" >
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        ...
                                                        <label class=" form-control-label">First Name</label>
                                                        <input style="text-transform: capitalize"  type="text" class="form-control form-control-lg form-control-solid lawyer_seller_first_name" name="lawyer_first_name" value="{{ isset($lawyer) ? $lawyer['first_name'] : '' }}">
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <br>
                                                        <label  class=" form-control-label">Last Name</label>
                                                        <input style="text-transform: capitalize"  type="text" class="form-control form-control-lg form-control-solid lawyer_seller_last_name" name="lawyer_last_name" value="{{ isset($lawyer) ? $lawyer['last_name'] : '' }}">
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        ...
                                                        <br/>
                                                        <label class="officer-label float-left" style="margin-right: 10px">
                                                            <input type="radio" name="lawyer_gender" value="male" class="card-input-officers-element lawyer_gender" @if(isset($lawyer) && $lawyer['gender'] == "male" ) checked @endif/>
                                                            <div style="" class="card-input-apro col-md-12">
                                                                <span class="label label-lg label-light-danger label-inline font-weight py-4">Male</span>
                                                            </div>
                                                        </label>
                                                        <label class="officer-label float-left">
                                                            <input type="radio" name="lawyer_gender" value="female" class="card-input-officers-element lawyer_gender"  @if(isset($lawyer) && $lawyer['gender'] == "female" ) checked @endif />
                                                            <div style="" class="card-input-apro col-md-12">
                                                                <span class="label label-lg label-light-success label-inline font-weight py-4">Female</span>
                                                            </div>
                                                        </label>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <br>
                                                        <label  class=" form-control-label">E-mail</label>
                                                        <input type="text" class="form-control form-control-lg form-control-solid lawyer_seller_email" name="lawyer_email" value="{{ isset($lawyer) ? $lawyer['email'] : '' }}">
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <br>
                                                        <label class=" form-control-label">Phone</label>
                                                        <input  type="tel"  class="form-control form-control-lg form-control-solid lawyer_seller_phone"  name="lawyer_phone" value="{{ isset($lawyer) ? $lawyer['phone'] : '' }}">
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <br>
                                                        <label class=" form-control-label">Fax</label>
                                                        <input type="text" class="form-control form-control-lg form-control-solid lawyer_seller_fax" name="lawyer_fax" value="{{ isset($lawyer) ? $lawyer['fax'] : '' }}">
                                                    </div>
    ...
    <div class="modal fade" id="add_account_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeSm" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="addAccountForm" class="form" method="POST" action="{{ route('payment.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div id="payment-info-part" class="row form-group payment-info-part" >
                                ...
                                <input hidden type="text"  class="form-control form-control form-control-solid " name="fileid"  value="{{ request()->segment(2) }}">
                                ...
                                {{--<div  id="MortgageLoc" class="col-12 col-md-12 MortgageLocmain">--}}
                                    ...
                                    {{--<select name="priority"  class="form-control form-control form-control-solid">--}}
                                        {{--<option value="0" class="form-control form-control-solid">First</option>--}}
                                        {{--<option value="0" class="form-control form-control-solid">Second</option>--}}
                                        {{--<option value="0" class="form-control form-control-solid">Third</option>--}}
                                        {{--<option value="0" class="form-control form-control-solid">Fourth</option>--}}
                                    {{--</select>--}}
                                    {{--<br>--}}
                                {{--</div>--}}
    ...
    <div class="modal fade" id="add_real_estate_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeSm" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="addRealtorForm" class="form" method="POST" action="{{ route('realtor.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div id="realtor-information" class="row form-group">
                                ...
                                <input hidden type="text" class="form-control form-control form-control-solid fileid" name="fileid" value="{{ request()->segment(2) }}">
                                ...
                                <div class="col-12 col-md-12 ">
                                    ...
                                    @elseif($fileinf['file_type'] == "Purchase")
...
<script>
    $(document).ready(function(){
            ...
            $(document).on('change','.fileElementId-'+id,function(){
                ...
                for (var i = 0; i < this.files.length; ++i) {
                    ...
                    $('.fileName-'+id).append('<div class="col-xl-'+col+' col-lg-'+col+' col-md-6 col-sm-12 filetoremo">\n' +
                        ...
                        '                                                                <!--begin: Icon-->\n' +
                        '                                                                <img alt="" class="max-h-65px" src="{{ asset('media/doc.svg') }}">\n' +
                        '                                                                <!--end: Icon-->\n' +
                        '                                                                <!--begin: Tite-->\n' +
        ...
        $('.terms_agree_first_login_btn').click(function(){
            ...
            $.ajax({
                url:"{{ route('user.first_login_terms.agree') }}",
                method:"POST",
                data:{
                    _token:'{!! csrf_token() !!}'} ,
                success:function(data){
